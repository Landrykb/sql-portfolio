# Business — Hidden Inventory Alert

## BleepxQuery SwiftLink Training Program

**Domain:** Business
**Challenge:** Hidden Inventory Alert
**Visualization:** Units Sold by Product Line
...
### Visualization Query
```sql
SELECT product_line, SUM(quantity) as total_qty FROM business_retail GROUP BY product_line ORDER BY total_qty DESC
```
